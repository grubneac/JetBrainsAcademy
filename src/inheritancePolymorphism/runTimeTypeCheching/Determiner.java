...
class Determiner {
    ...
    public static void main(String[] args) {
        Employee[] employees = new Employee[]{new Developer("name", "email", 12, "Java", null)
                , new Employee("nameEmployee", "emailEmpl", 13)
                , new DataAnalyst("nameDA", "emailDA", 1, true, null)};
        determineWhoIsWho(employees);
    }
